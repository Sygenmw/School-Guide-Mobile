...
class ControlledAnimation<T> extends StatefulWidget {
  ...
  late Widget Function(BuildContext buildContext, T animatedValue)? builder;
...
class _ControlledAnimationState<T> extends State<ControlledAnimation<T>> with SingleTickerProviderStateMixin {
